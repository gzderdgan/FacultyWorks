<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexAdminMaterial.aspx.cs" Inherits="ProjectStockSystem.IndexAdminMaterial" %>
<!DOCTYPE html>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <asp:GridView ID="gwMalzeme" runat="server" Height="231px" Width="732px" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourceMaterial" ForeColor="#333333" DataMember="DefaultView" AllowPaging="True" AllowSorting="True" PageSize="20" OnSelectedIndexChanged="gwMalzeme_SelectedIndexChanged">
