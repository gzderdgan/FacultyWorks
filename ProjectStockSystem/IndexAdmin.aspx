    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <div class="container-fluid">
            ...
            <asp:Panel ID="pnlTexboxs" runat="server" Height="210px" Width="607px"   HorizontalAlign="Center" style="margin-left:150px;">
            <table style="width:400px; height:100px; align-content:center;" >
                <tr>
                    ...
                    <td style="text-align:left; height:40px;">
                        <asp:TextBox ID="tbSistemTcNo" runat="server" BackColor="#CCEEFF" Height="25px" Width="200px" AutoPostBack="True"></asp:TextBox></td>
                ...
                <tr>
                   ...
                   <td style="height:40px;">
                       <asp:Button ID="btnSistemKaydet0" runat="server" Height="30px" OnClick="btnSistemKaydet_Click" Text="Kaydet" Width="120px" />
                    </td>
                ...
                <table class="auto-style1">
                    <tr>
                        <td class="auto-style2">
                            <asp:GridView ID="gwAdmin" runat="server" AutoGenerateColumns="False" DataKeyNames="userId" DataSourceID="SqlDataSourceAdmin" DataMember="DefaultView" Caption="Admins" CaptionAlign="Top" CellPadding="4" ForeColor="#333333" Width="397px">
