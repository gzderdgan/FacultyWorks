<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexLecturer.aspx.cs" Inherits="ProjectStockSystem.IndexLecturer" %>
        ...
        <div id="page-wrapper" class="auto-style1">
            ...
            <div class="container-fluid">
                ...
                <asp:Panel ID="Panel1" runat="server" Height="341px">
                    <asp:ListView ID="listVİewReservations" runat="server">
                    </asp:ListView>
                </asp:Panel>
