<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ProjectStockSystem.Login" %>
...
<div class="login">
    <h1>Login</h1>
    	<input type="text" value="" name="usernameTextBox" runat="server" id="username_input" placeholder="username"/><br/>
