...
namespace ProjectStockSystem
{
    public partial class IndexStocker : System.Web.UI.Page
    {
        ...
        protected void gwMalzeme_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //int x = ddMalzemeDurumu.Items.IndexOf(ddMalzemeDurumu.Items.FindByText(gwMalzeme.SelectedRow.Cells[4].Text));
            ddMalzemeDurumu.SelectedIndex = ddMalzemeDurumu.Items.IndexOf(ddMalzemeDurumu.Items.FindByText(gwMalzeme.SelectedRow.Cells[4].Text));
            ddlMalzemeTipi.SelectedIndex = ddMalzemeDurumu.Items.IndexOf(ddMalzemeDurumu.Items.FindByText(gwMalzeme.SelectedRow.Cells[5].Text));
            ddlMalzemeCalisma.SelectedIndex = ddMalzemeDurumu.Items.IndexOf(ddMalzemeDurumu.Items.FindByText(gwMalzeme.SelectedRow.Cells[6].Text));
